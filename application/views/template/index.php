...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <meta name="viewport" content="SMPN 9 Sungai Penuh, SMPN 9, Sungai Penuh, SMPN 9 SPN, Sungai, Penuh, SPN, SMP 9 Sungai Penuh,">
    <meta name="description" content="SMPN 9 Sungai Penuh">
    <meta name="author" content="SMPN 9 Sungai Penuh">
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/img/favicon.png">

    <title>SMP NEGERI 9 Sungai Penuh</title>
